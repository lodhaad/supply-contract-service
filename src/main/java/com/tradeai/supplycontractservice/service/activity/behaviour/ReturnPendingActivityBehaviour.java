...
@Component("ReturnPendingActivityBehaviour")
public class ReturnPendingActivityBehaviour implements PendingBehaviour {
	...
	public SupplyContractDTO onPendingAction(SupplyContractDTO contract) {
		...
		activity.setActivityType(contractData.getActivityType());
		...
		status.setActivityType(contractData.getActivityType());
