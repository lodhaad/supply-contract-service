...
@Component("ReturnSettledActivityBehaviour")
public class ReturnSettledActivityBehaviour  implements SettledBehaviour {
		...
		public SupplyContractDTO onSettledBehaviour(SupplyContractDTO contract) {
			...
			status.setActivityType(contractDomain.getActivityType());
